    ...
    <header className="relative z-30 container mx-auto px-4 py-6">
      <nav className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Button variant="ghost" className="text-purple-200 hover:text-white hover:bg-purple-800/30" onClick={() => navigate("/discover")}>
          ...
          {user ? (
            <div className="flex items-center space-x-2">
              ...
              <Button variant="ghost" className="text-purple-200 hover:text-white hover:bg-purple-800/30" onClick={() => navigate(`/profile/${user.id}`)}>
                <User className="h-4 w-4 mr-2" />
                Profile
              </Button>
              <Button variant="outline" className="border-purple-500 text-purple-200 hover:bg-purple-700" onClick={handleSignOut}>
        ...
        {/* Mobile Menu Button */}
        <Button variant="ghost" onClick={() => setIsMenuOpen(!isMenuOpen)} className="md:hidden hover:bg-purple-800/30 font-normal text-slate-50">
